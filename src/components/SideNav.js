...
const SideNav = ({profileData}) => {
  ...
  return (
    <>
             <div className="bg-gray-50 fixed mt-20 w-1/5 h-screen md:flex dark:border-r border-r-2 hidden dark:bg-slate-800 dark:text-white text-lg dark:border-r-gray-500 pt-16  ">
                              <div className="w-full">
                                    <ul className="text  border-b border-b-gray-500 pl-24 pb-10 w-4/5 lg:mx-auto ">
                                        <NavLink to='/dashboard' className={'flex hover:font-bold hover:transition hover:underline underline-offset-2 ease-in-out md:-translate-x-16 hover:scale-110 '}>
                                                <FaTachometerAlt className="text-lg mr-3  my-8"/>
                                                <li className=" border-gray-400 text-lg my-6 "  exact activeclassName={active} >DASHBOARD</li>
                                          </NavLink>
