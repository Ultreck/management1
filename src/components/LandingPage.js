...
const Dashboard = () => {
  ...
  return (
    ...
    <div className={loader}></div>
     <main className=" flex font-medium">
            <div className="text-black md:w-1/4 hidden lg:flex bg-slate-100 dark:bg-slate-700 dark:text-white h-screen p-8">
                 <div className="text-sm">
                        <p className="text dark:text-white font-semibold ">
                              Welcome to <span className="text-blue-500  font-mono font-bold">WastroTech </span><span className="text-blue-500"> Medical Management System.</span> a leading health centre, offering a range of medical services like <span className="">Chiropractic, Physical Therrapy, Dentist </span>and <span className="">Eye Exam.</span>
                        </p>
                        <p className="text-black mt-6  dark:text-white font-semibold ">We specialising  in working  with different issues and our ability to provide medical services in over 20 languages, we are sure you will find the right doctor to help you. We work with individuals, couples and families, supporting adults, children and adolescents.</p>
                         <div className="text-center mx-auto py-5 bg-neutral-200 rounded shadow-inner shadow-gray-700 drop-shadow-lg mt-5">
            ...
            <div className="text w-full bg-slate-50  bg-fixed bg-no-repeat bg-cover h-screen overflow-auto scroll-smooth" style={{backgroundImage:`url(${img})`}}>
                 ...
                 <h1 className="z-auto text-center mt-10 text-xl font-extrabold font-mono bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-red-400 to-blue-600">Medical Management System</h1>
                 <div className="z-10 text bg-slate-200 mx-6  md:w-3/4 md:mx-auto rounded-tl-lg rounded-tr-lg">
                        <div className="z-10 text md:w-3/4 mx-auto mt-72">
                              <h3 className="z-10 text-center font-semibold pt-10 pb-2">The chiropractic treatments we provide</h3>
                              <p className="z-10 mx-auto px-6">We offer chiropractic treatment for the whole family. From babies and children, through to adults of all ages, we are dedicated to providing you with an outstanding experience, and effective treatment.
                        ...
                        <div className="z-10 text md:w-3/4 mx-auto">
                              <h3 className="z-10 text-center font-semibold mt-10 pb-2">Physical Therapy We Provide</h3>
                              <p className="z-10 mx-auto px-6 "> Orthopaedics, in conjuction with  
                        ...
                        <div className="z-10 text md:w-3/4 mx-auto" >
                              <h3 className="z-10 text-center font-semibold mt-10 pb-2">We Provide Kid Friendly Dentist</h3>
                              <p className="z-10 mx-auto px-6 ">As a kid friendly dentist in Nigeria we treat young children, including preschooler and elementary age children, for their first checkup. We
                        ...
                        <div className="z-10 text md:w-3/4 mx-auto pb-10">
                              <h3 className="z-10 text-center font-semibold mt-10 pb-2">We Provide Eye Exams</h3>
                              <p className="z-10 mx-auto px-6 ">Here we do things differently 
