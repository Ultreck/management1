                        ...
                        <div className="text  w-1/4 hidden md:flex dark:text-gray-300">
                             <div className="text border-r-2 sm:border-r-0 border-r-gray-400 h-12 w-3/5">
                                    <a href="##" className="text">
                                          <FaBell className='hidden md:flex absolute right-72  mt-3 text-2xl '/>
                                    </a>
                             </div>
                             <div className="hidden object-fill md:flex absolute right-40 w-14 h-14 bg-gray-200 rounded-full -translate-y-2 border border-gray-500 dark:bg-gray-500">
                             {!profilePics? 
